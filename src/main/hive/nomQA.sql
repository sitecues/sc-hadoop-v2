...
SELECT 
 filename,
 regexp_extract(filename, '([0-9]{4,4})([0-9]{2,2})([0-9]{2,2})', 1) AS year,
 regexp_extract(filename, '([0-9]{4,4})([0-9]{2,2})([0-9]{2,2})', 2) AS month,
 regexp_extract(filename, '([0-9]{4,4})([0-9]{2,2})([0-9]{2,2})', 3) AS day,
 COUNT(1) 
FROM optimized_clean_nom_log GROUP BY filename ORDER BY year,month,day DESC ;
